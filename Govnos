...
notificationFrame.Position = UDim2.new(0, 0, 10, 0)
...
notificationText.Text = "ВАЛЕРА ГЕЙ"
notificationText.TextColor3 = Color3.new(1, 1, 1)
notificationText.TextSize = 21
...
FOV_CIRCLE.Radius = 10 -- Change this value to adjust the radius of the circle.
...
if settings.recenter then
    getgenv().crosshair_x["Connection"] = cam:GetProperty
